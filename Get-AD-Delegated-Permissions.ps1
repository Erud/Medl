...
$bSearch = New-Object System.DirectoryServices.DirectoryEntry("LDAP://medline.com/DC=medline,DC=com") #connect to DOMAINCONTROLLER using LDAP path
...
$results | Export-Csv -Path "C:\temp\OU_Delegated_Permissions.csv" -NoTypeInformation