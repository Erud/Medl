...
$Servers += 'NPS_Server1'     #You must change it to name of Your NPS/RADIUS Server
...
$logs = '\Logs\'          #You must change it to name of Your shared folder with NPS/RADIUS Logs with '\' char at the beginning and at the end
